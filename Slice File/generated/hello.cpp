...
::std::string
IceProxy::Demo::Hello::SayHello(const ::std::string& __p_s, const ::Ice::Context* __ctx)
{
    __checkTwowayOnly(__Demo__Hello__SayHello_name);
    ::IceInternal::Outgoing __og(this, __Demo__Hello__SayHello_name, ::Ice::Normal, __ctx);
    try
    {
...
::Ice::AsyncResultPtr
IceProxy::Demo::Hello::begin_SayHello(const ::std::string& __p_s, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
    ...
    try
    {
        __result->prepare(__Demo__Hello__SayHello_name, ::Ice::Normal, __ctx);
...
::Ice::AsyncResultPtr
IceProxy::Demo::Hello::__begin_SayHello(const ::std::string& __p_s, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
{
    ...
    return begin_SayHello(__p_s, __ctx, new Cpp11CB(__response, __exception, __sent));
}
#endif
...
Demo::Hello::___SayHello(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(__p_s);
    __inS.endReadParams();
    ::std::string __ret = SayHello(__p_s, __current);
