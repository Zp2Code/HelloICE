...
#ifndef __generated_hello_h__
#define __generated_hello_h__
...
public:
    ...
    ::std::string SayHello(const ::std::string& __p_s)
    {
        return SayHello(__p_s, 0);
    }
    ::std::string SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx)
    {
        return SayHello(__p_s, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_SayHello(const ::std::string& __p_s, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_SayHello(__p_s, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_SayHello(const ::std::string& __p_s, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_SayHello(__p_s, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_SayHello(__p_s, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_SayHello(__p_s, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_SayHello(const ::std::string& __p_s, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (const ::std::string&)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s)
    {
        return begin_SayHello(__p_s, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx)
    {
        return begin_SayHello(__p_s, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SayHello(__p_s, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SayHello(__p_s, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s, const ::Demo::Callback_Hello_SayHelloPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SayHello(__p_s, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_SayHello(const ::std::string& __p_s, const ::Ice::Context& __ctx, const ::Demo::Callback_Hello_SayHelloPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_SayHello(__p_s, &__ctx, __del, __cookie);
    }
